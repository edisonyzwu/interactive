...
<section id="scrolly">
	<div class="sticky">
		...
		{:else if value === 3}
			<img src={`${base}/project/driver.png`} alt="immigrant workers" />
		{:else if value === 4}
			<img src={`${base}/project/hospital.png`} alt="immigrant workers" />
		{:else if value === 5}
			<img src={`${base}/project/leave.png`} alt="immigrant workers left" />
		{:else}
